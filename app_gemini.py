...
from shared import inject_css, db, get_all_competitions, load_settings, COMPETITIONS_BUILTIN, DIFFICULTY_OPTIONS, TOPICS, footer, topbar
from pages_student import page_login, page_dashboard, page_exam, page_result, page_history, page_leaderboard
...
def main():
    ...
    else: st.error(f"Unknown page: {page}"); st.session_state["page"]="login"; st.rerun()
